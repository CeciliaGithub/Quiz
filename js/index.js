...
window.addEventListener("DOMContentLoaded", () => {
        ...
        if (sec == 0) {
          ...
          if (flag != 2) {
            document.getElementById("errMsg").innerHTML =
              "Sorry! Exceeded  quiz time.Please Click Reset button at the bottom to do the quiz again";
  ...
  const quizArray = [
    ...
    {
      q: "How many Teritories does Australia have?",
      o: ["4", "2", "7", "6"],
      a: 1,
    },
    {
      q: "Where is Opera House Located?",
      o: ["Melbourne", "Sydney", "Canbera", "Brisbane"],
      a: 1,
    },
  ];
